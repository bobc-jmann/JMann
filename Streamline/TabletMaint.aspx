<%@ Page Title="Tablet Maintenance" Language="VB" Theme="DevEx" AutoEventWireup="false" CodeFile="TabletMaint.aspx.vb" Inherits="TabletMaint" %>
    ...
    <div style="position:relative;top:0;left:0;">
        <table runat="server" id="tblMenu" border="0" width="100%" cellpadding=2 cellspacing=0 style="border:0px gainsboro inset">
            <tr id="hdrTR" runat="server" style="background-color:beige;font-size:smaller">
                <td><dx:ASPxLabel Wrap="False" Font-Size="X-Large" ID="lblPageTitle" Text="Tablet Maintenance" runat="server"></dx:ASPxLabel></td>
            </tr>
        </table>
    </div>
    <br />
            ...
            <tr>
                <td style="width: 40%">
                    <dx:ASPxGridView ID="grid" ClientInstanceName="grid" runat="server" 
						DataSourceID="dsTablets" KeyFieldName="TabletID" Width="100%" 
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataColumn FieldName="TabletID" Visible="false" /> 
                            <dx:GridViewDataColumn FieldName="Active" HeaderStyle-HorizontalAlign="Center" Width="50" /> 
                            <dx:GridViewDataColumn FieldName="TabletName" /> 
                    ...
                    <asp:SqlDataSource ID="dsTablets" runat="server"
                        ...
                        InsertCommand="INSERT INTO tblTablets (TabletName, DriverLocationID, Active) VALUES (@TabletName, @DriverLocationID, @Active)"
                        UpdateCommand="UPDATE tblTablets SET TabletName = @TabletName, DriverLocationID = @DriverLocationID, Active = @Active WHERE TabletID = @TabletID">
                        <InsertParameters>
                            <asp:Parameter Name="TabletName" Type="String" />
