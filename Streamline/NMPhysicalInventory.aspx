<%@ Page Title="Physical Inventory" Language="VB" Theme="Youthful" AutoEventWireup="true" CodeFile="NMPhysicalInventory.aspx.vb" Inherits="NMPhysicalInventory" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
     	function SearchByUPC_Click(s, e) {
    		var upc = flPI_tbSearchByUPC.GetValue();
...
<body>
    <form id="Form1" runat="server">
				...
				<tr id="hdrTR" runat="server" style="background-color:beige;font-size:smaller">
					<td>
						<dx:ASPxLabel Wrap="False" Font-Size="X-Large" ID="lblPageTitle" 
							Text="Physical Inventory" runat="server"></dx:ASPxLabel>
					</td>
				</tr>
			</table>
		</div>
		...
		<dx:ASPxFormLayout ID="flPI" runat="server" ColCount="4" 
			...
			<Items>
				...
				<dx:LayoutGroup ShowCaption="False" ColCount="2" ColSpan="2">
					<Items>
						...
						<dx:LayoutItem Caption="Physical Inventory Date/Time" ColSpan="2">
							<LayoutItemNestedControlCollection>
								<dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer2" runat="server">
									<dx:ASPxDateEdit ID="tbInventoryDate" runat="server" Width="200px"
						...
						<dx:LayoutItem FieldName="QtyActual" Caption="Actual Qty On Hand">
							<LayoutItemNestedControlCollection>
								<dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer18" runat="server">
									<dx:ASPxSpinEdit ID="tbQtyActual" ClientInstanceName="tbQtyActual" runat="server" Width="200px" 
		...
		<br />
		<br />
		<dx:ASPxGridView ID="grid" ClientInstanceName="grid" runat="server" DataSourceID="dsPhysicalInventory" 
			KeyFieldName="PhysicalInventoryID" Width="100%" EnableRowsCache="true" SettingsBehavior-ConfirmDelete="True"
			...
			<Columns>
                ...
                <dx:GridViewDataColumn FieldName="PhysicalInventoryID" Visible="False" /> 
                ...
                <dx:GridViewDataDateColumn FieldName="InventoryDate" Caption="Date/Time" >
                ...
                <dx:GridViewDataTextColumn FieldName="QtyActual" Caption="Actual">
                    <PropertiesTextEdit ClientInstanceName="QtyActual" DisplayFormatString="#,0" />
                    <HeaderStyle HorizontalAlign="Right" Wrap="True"></HeaderStyle>
				</dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="QtyOnHand" Caption="On Hand" ReadOnly="true">
                    <PropertiesTextEdit ClientInstanceName="QtyOnHand" DisplayFormatString="#,0" />
                    <HeaderStyle HorizontalAlign="Right" Wrap="True"></HeaderStyle>
					<EditCellStyle BackColor="WhiteSmoke" />
					<CellStyle BackColor="WhiteSmoke" />
				</dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="QtyAdjustment" Caption="Adjustment" ReadOnly="true">
                    <PropertiesTextEdit ClientInstanceName="QtyAdjustment" DisplayFormatString="#,0" />
                    <HeaderStyle HorizontalAlign="Right" Wrap="True"></HeaderStyle>
					<EditCellStyle BackColor="WhiteSmoke" />
					<CellStyle BackColor="WhiteSmoke" />
				</dx:GridViewDataTextColumn>
        ...
        <asp:SqlDataSource ID="dsPhysicalInventory" runat="server"
            ConnectionString="<%$ ConnectionStrings:App-NewMerchConnectionString%>"
            SelectCommand="NewMerch.spPhysicalInventory_Select"
			SelectCommandType="StoredProcedure"
            UpdateCommand="NewMerch.spPhysicalInventory_Update"
			UpdateCommandType="StoredProcedure"
			DeleteCommand="NewMerch.spPhysicalInventory_Delete"
			DeleteCommandType="StoredProcedure">
			<SelectParameters>
				<asp:ControlParameter ControlID="hfStoreID" Name="StoreID" PropertyName="Value" Type="Int32" />
			</SelectParameters>
            <UpdateParameters>
				<asp:Parameter Name="PhysicalInventoryID" Type="Int32" />
				...
				<asp:Parameter Name="QtyActual" Type="Int32" />
