<%@ Page Title="Container Carts and Grading" Language="VB" Theme="DevEx" AutoEventWireup="false" CodeFile="ContainerCartsGrading.aspx.vb" Inherits="ContainerCartsGrading" %>
    ...
    <div style="position:relative;top:0;left:0;">
        <table runat="server" id="tblMenu" border="0" width="100%" cellpadding=2 cellspacing=0 style="border:0px gainsboro inset">
            <tr id="hdrTR" runat="server" style="background-color:beige;font-size:smaller">
                <td><dx:ASPxLabel Wrap="False" Font-Size="X-Large" ID="lblPageTitle" Text="Container Carts and Grading" runat="server"></dx:ASPxLabel></td>
            </tr>
        </table>
    </div>
    <br />
    ...
    <div id="divSearch" class="specials" runat="server">
        <table width="100%">
            <tr>
                ...
                <td style="width: 40%">
                    <dx:ASPxButton runat="server" ID="btnContainerPickupsNotGradedReport" Text="Container Pickups Not Graded Report" OnClick="btnRunContainerPickupsNotGradedReport_Click" AutoPostBack="True" Width="60%"></dx:ASPxButton>
                </td>
            </tr>
            <tr>
 				<td style="width: 20%">
                ...
                <td></td>
                <td>
                    <dx:ASPxCheckbox runat="server" ID="ckShowAllPickups" Text="Show All Pickups" AutoPostBack="true"></dx:ASPxCheckbox>
                </td>
                <td></td>
          </tr>
        </table>
        <br />
        <table id="tblContainerPickupsNotGraded" runat="server" style="visibility: visible">
            <tr>
                <td style="width: 100%" colspan="5">

                    <dx:ASPxGridView ID="grdContainerPickupsNotGraded" KeyFieldName="PickupID" runat="server" DataSourceID="dsContainerPickupsNotGraded" Width="100%" EnableRowsCache="False" AutoGenerateColumns="False" Settings-VerticalScrollBarMode="Auto" Settings-VerticalScrollableHeight="300">
                        <Columns>
                            ...
                            <dx:GridViewDataColumn FieldName="Address" VisibleIndex="2" EditFormSettings-Visible="False" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Wrap="True" MinWidth="200">
                                <EditFormSettings Visible="False"></EditFormSettings>
                                <HeaderStyle HorizontalAlign="Center" Wrap="True"></HeaderStyle>
                            </dx:GridViewDataColumn>
                            ...
                            <dx:GridViewDataComboBoxColumn FieldName="DriverID" VisibleIndex="7" Caption="Driver" HeaderStyle-HorizontalAlign="Center" MinWidth="100">
                                <PropertiesComboBox DataSourceID="dsDrivers" TextField="DriverName" ValueField="DriverID" ValueType="System.Int32" />
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            </dx:GridViewDataComboBoxColumn>
                            <dx:GridViewDataTextColumn FieldName="SoftCarts" VisibleIndex="8" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Wrap="True">
                                <PropertiesTextEdit ClientInstanceName="ItemOther" />
                                <HeaderStyle HorizontalAlign="Center" Wrap="True"></HeaderStyle>
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="HardCarts" VisibleIndex="9" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Wrap="True">
                                <PropertiesTextEdit ClientInstanceName="ItemOther" />
                                <HeaderStyle HorizontalAlign="Center" Wrap="True"></HeaderStyle>
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTimeEditColumn FieldName="EndTime" VisibleIndex="11" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Wrap="True">
                                <PropertiesTimeEdit ClientInstanceName="EndTime" DisplayFormatString="HH:mm" EditFormatString="HH:mm" />
                                <HeaderStyle HorizontalAlign="Center" Wrap="True"></HeaderStyle>
                            </dx:GridViewDataTimeEditColumn>
                            <dx:GridViewDataComboBoxColumn FieldName="Grade" VisibleIndex="12" Caption="Grade" HeaderStyle-HorizontalAlign="Center" MinWidth="100">
                                <PropertiesComboBox DataSourceID="dsGrade" TextField="Grade" ValueField="Grade" ValueType="System.String" />
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            </dx:GridViewDataComboBoxColumn>
                            <dx:GridViewDataComboBoxColumn FieldName="Status" VisibleIndex="14" Caption="Status" HeaderStyle-HorizontalAlign="Center" MinWidth="100">
                    ...
                    <asp:SqlDataSource ID="dsContainerPickupsNotGraded" runat="server"
                        ConnectionString="<%$ ConnectionStrings:App-MainConnectionString%>"
                        UpdateCommand="UPDATE [tblContainers] SET [ItemBags] = @ItemBags, [ItemBoxes] = @ItemBoxes, [ItemOther] = @ItemOther, [DriverID] = @driverID, [SoftCarts] = @SoftCarts, [HardCarts] = @HardCarts, [EndTime] = @EndTime, [Grade] = @Grade, [Status] = @Status, ModifiedOn = SYSDATETIME(), ModifiedBy = @Username WHERE [PickupID] = @PickupID">
                        <UpdateParameters>
                            ...
                            <asp:Parameter Name="SoftCarts" Type="String" />
                            <asp:Parameter Name="HardCarts" Type="String" />
