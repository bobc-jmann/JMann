...
namespace @__ASP {
    ...
    internal class FastObjectFactory_app_web_edcykhnq {
        ...
        private FastObjectFactory_app_web_edcykhnq() {
        }
        ...
        static object Create_ASP_sys_reportserver_aspx() {
            return new ASP.sys_reportserver_aspx();
        }
    }
}
